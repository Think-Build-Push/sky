...
final class CreateMemAuthTable extends AbstractMigration
{
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn($this->table_name . '_login', 'string', ['limit' => 255, 'null' => TRUE])
				->addColumn($this->table_name . '_password', 'string', ['limit' => 100, 'null' => TRUE])
