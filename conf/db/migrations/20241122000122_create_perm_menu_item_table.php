...
final class CreatePermMenuItemTable extends AbstractMigration
{
	private string $table_name = '_perm_menu_item';
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn('fk__menu_item_id', 'integer', ['null' => TRUE])
				->addColumn($this->table_name . '_sort_order', 'smallinteger', ['null' => TRUE])
