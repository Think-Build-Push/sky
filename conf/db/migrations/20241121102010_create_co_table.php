...
final class CreateCoTable extends AbstractMigration
{
	private string $table_name = '_co';
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn($this->table_name . '_setup', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_configured', 'boolean', ['default' => FALSE])
				...
				->addColumn($this->table_name . '_domain', 'string', ['limit' => 255, 'null' => TRUE])
				->addColumn($this->table_name . '_ulid', 'char', ['limit' => 26, 'null' => TRUE])
				->addIndex([$this->table_name . '_domain'], ['name' => 'idx_' . $this->table_name . '_domain'])
