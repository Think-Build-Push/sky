...
final class CreateAdminObjTable extends AbstractMigration
{
	private string $table_name = '_admin_obj';
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn($this->table_name . '_table', 'string', ['limit' => 255, 'null' => TRUE])
				->addColumn($this->table_name . '_obj', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_ctlr', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_page', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_perm', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_role_perm', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_save_modal', 'boolean', ['default' => FALSE])
				->addColumn($this->table_name . '_valid_form', 'boolean', ['default' => FALSE])
