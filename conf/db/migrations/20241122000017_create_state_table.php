...
{
	private string $table_name = '_state';
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn('fk__country_id', 'integer', ['null' => TRUE])
				->addColumn($this->table_name . '_name', 'string', ['limit' => 75, 'null' => TRUE])
				->addColumn($this->table_name . '_iso_abbrev', 'string', ['limit' => 3, 'null' => TRUE])
				->addColumn($this->table_name . '_full_iso', 'string', ['limit' => 6, 'null' => TRUE])
