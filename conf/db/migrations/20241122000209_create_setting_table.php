...
final class CreateSettingTable extends AbstractMigration
{
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn($this->table_name . '_is_sensitive', 'boolean', ['default' => TRUE])
				->addColumn($this->table_name . '_key', 'string', ['limit' => 255, 'null' => TRUE])
				->addColumn($this->table_name . '_value', 'string', ['limit' => 255, 'null' => TRUE])
