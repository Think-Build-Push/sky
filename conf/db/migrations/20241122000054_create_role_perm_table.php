...
final class CreateRolePermTable extends AbstractMigration
{
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn('fk__co_id', 'integer', ['null' => TRUE, 'comment' => 'If NULL, the role_perm is for the superadmin role type which has access to all _co\'s'])
				->addColumn('fk__role_id', 'integer', ['null' => TRUE])
				->addColumn('fk__perm_id', 'integer', ['null' => TRUE])
