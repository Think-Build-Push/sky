...
final class CreateCoSubMetricTable extends AbstractMigration
{
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn('fk__co_sub_plan_id', 'integer', ['null' => TRUE])
				->addColumn($this->table_name . '_count', 'integer', ['default' => 0, 'null' => TRUE])
				->addColumn($this->table_name . '_count_over', 'integer', ['default' => 0, 'null' => TRUE])
