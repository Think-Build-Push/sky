...
{
	private string $table_name = '_country';
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn($this->table_name . '_name', 'string', ['limit' => 75, 'null' => TRUE])
				->addColumn($this->table_name . '_official_name', 'string', ['limit' => 75, 'null' => TRUE])
				->addColumn($this->table_name . '_iso2', 'char', ['limit' => 2, 'null' => TRUE])
				->addColumn($this->table_name . '_iso3', 'char', ['limit' => 2, 'null' => TRUE])
				->addColumn($this->table_name . '_numeric', 'integer', ['null' => TRUE])
