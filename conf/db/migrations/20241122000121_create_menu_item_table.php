...
{
	private string $table_name = '_menu_item';
	...
	public function up(): void
	{
		...
		$table->addColumn($this->table_name . '_new', 'timestamp', ['default' => 'CURRENT_TIMESTAMP'])
				...
				->addColumn('fk__menu_item_id', 'integer', ['null' => TRUE, 'comment' => 'parent menu_item for nested menus'])
				->addColumn($this->table_name . '_label', 'string', ['limit' => 30, 'null' => TRUE])
				->addColumn($this->table_name . '_hover', 'string', ['limit' => 30, 'null' => TRUE])
				->addColumn($this->table_name . '_href', 'string', ['limit' => 255, 'null' => TRUE])
				->addColumn($this->table_name . '_icon', 'string', ['limit' => 255, 'null' => TRUE])
				->addColumn($this->table_name . '_group', 'string', ['limit' => 30, 'null' => TRUE])
				->addColumn($this->table_name . '_target', 'string', ['limit' => 255, 'null' => TRUE])
